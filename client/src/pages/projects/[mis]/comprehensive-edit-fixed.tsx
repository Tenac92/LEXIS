...
export default function ComprehensiveEditFixed() {
  ...
  if (isCompleteDataLoading || isReferenceDataLoading) {
    return (
  ...
  if (completeDataError || referenceDataError) {
    return (
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8">
          <div className="text-center">
            ...
            <p className="text-gray-600">
              {completeDataError?.message || referenceDataError?.message || "Παρουσιάστηκε σφάλμα κατά τη φόρτωση των δεδομένων"}
            </p>
          </div>
        </div>
      </div>

...
import { DecisionsTab, EventLocationTab, ProjectDetailsTab, FormulationTab, SubprojectsTab, ChangesTab } from "./ComprehensiveEditSections";

import { EuropeanNumberInput, comprehensiveProjectSchema, generateEnumerationCode, getDecisionBorderColor, getDecisionColor, getSABorderColor, getSAColor, normalizeFekData, safeText, useSAValidation, validateAndLimitNumericInput } from "./ComprehensiveEditHelpers";
...
/* Extracted validateAndLimitNumericInput to ComprehensiveEditHelpers.ts */
...
<Button
  ...
  onClick={() => {
    ...
    // Optional: prefill a unique enumeration_code per SA using our helper
    const saType = "ΝΑ853";
    const enumeration_code = generateEnumerationCode(
      saType,
      undefined,
      {} // you can pass existingEnumerationCodes if you track them
    );

    const newFormulation = {
      sa: saType as "ΝΑ853" | "ΝΑ271" | "E069",
      enumeration_code,
      decision_year: "",
      decision_status: "Ενεργή" as const,
      change_type: "Έγκριση" as const,
      ...
      budget_versions: {
        pde: [] as Array<{
          ...
          action_type: "Έγκριση" | "Τροποποίηση" | "Κλείσιμο στο ύψος πληρωμών";
          comments: string;
        }>,
        epa: [] as Array<{
          version_number: string;
...
export default ComprehensiveEditFixed;

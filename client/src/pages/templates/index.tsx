    ...
    <div className="container mx-auto py-8">
      <div className="mb-4 p-4 bg-amber-50 border border-amber-200 rounded-lg">
        <p className="text-sm text-amber-800">
          ⚠️ <strong>Υπό ανάπτυξη:</strong> Η διαχείριση προτύπων βρίσκεται σε
          αρχικό στάδιο υλοποίησης. Ορισμένες λειτουργίες δεν είναι ακόμη
          διαθέσιμες.
        </p>
      </div>
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-muted-foreground">
            Διαχείριση προτύπων για τα διαβιβαστικά έγγραφα
          </p>
        </div>
            ...
            <CardContent>
              <div className="flex flex-col gap-2">
                ...
                {template.expenditure_type && (
                  <div className="text-sm">
                    <span className="font-medium">Τύπος Δαπάνης:</span>{" "}
                    {template.expenditure_type}
                  </div>
                )}

...
try:
    ...
    for corrupted, correct in replacements.items():
        ...
        if count > 0:
            print(f"Found {count} instance(s) of: {corrupted}")
    ...
    print(f"\nFile fixed successfully! Total replacements made: {total_replacements}")

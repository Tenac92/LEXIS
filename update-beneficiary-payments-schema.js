...
async function updateBeneficiaryPaymentsSchema() {
  try {
    ...
    const constraintQueries = [
      ...
      'ALTER TABLE beneficiary_payments ADD CONSTRAINT beneficiary_payments_expenditure_type_id_fkey FOREIGN KEY (expenditure_type_id) REFERENCES expenditure_types (id);',
